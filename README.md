...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pymov2gif-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15423&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pymov2gif-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pymov2gif` can be installed with:

```
conda install pymov2gif
```

It is possible to list all of the versions of `pymov2gif` available on your platform with:
